...
Model: wtgain, parity, smoken, ppwt, gaweeks,
...
<img src="p8105_hw6_dm3175_files/figure-markdown_github/unnamed-chunk-7-1.png" width="90%" />

``` r
fit_lm_birthweight_1 = lm(bwt ~ wtgain + smoken + ppwt + parity + gaweeks, data = birthweight_data) %>%
    broom::glance()
```
...
Comparison of models against two others:
